                ...
                <div class="col-12 col-lg-5 col-xl-4">
                    ...
                    <div class="box box-inverse bg-img" style=" background-image: url({{ asset('backend/images/gallery/full/1.jpg') }});" data-overlay="2">
                        ...
                        <div class="box-body text-center pb-50">
                            <a href="#">
                                <img class="avatar avatar-xxl avatar-bordered" src="{{ (!empty($adminData->profile_photo_path))? url('upload/user_images/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" alt="">
                            </a>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div>
                                        ...
                                        <p>Name :<span class="text-gray pl-10">{{ $adminData->name }}</span></p>
